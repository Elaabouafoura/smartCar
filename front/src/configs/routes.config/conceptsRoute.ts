...
const conceptsRoute: Routes = [
    ...
    },
    {
        ...
        component: lazy(() => import('@/views/concepts/MyVehiclesDashboard/index')),
        authority:[ ADMIN,USER],
    },
   {
    key: 'concepts.products.productEdit',
    path: `${CONCEPTS_PREFIX_PATH}/vehicles/vehicle-edit/:id`,
    component: lazy(() => import('@/views/concepts/vehicles/VehicleEdit')),
    authority:[ ADMIN,USER],
    meta: {
        header: {
            title: 'Edit vehicle',
...
},
   {
    ...
    component: lazy(() => import('@/views/concepts/vehicles/VehicleCreate')),
    authority:[ ADMIN,USER],
    meta: {
        header: {
    ...
    {
        key: 'concepts.products.vehicleDetails',
        path: `${CONCEPTS_PREFIX_PATH}/vehicles/vehicle-details/:id`,
        component: lazy(() => import('@/views/concepts/vehicles/vehicleDetails')),
        authority: [ ADMIN,USER],
        meta: {
            pageContainerType: 'contained',
        },
    ...
    {
        key: 'concepts.products.vehicleUpload',
        path: `${CONCEPTS_PREFIX_PATH}/vehicles/vehicle-upload/:id`,
        component: lazy(() => import('@/views/concepts/vehicles/VehicleUpload')),
        authority: [ ADMIN,USER],
        meta: {
            pageContainerType: 'contained',
        },
    ...
    component: lazy(() => import('@/views/concepts/uploads/UploadList')),
    authority: [ADMIN],
    meta: {
        pageContainerType: 'contained',
    },
